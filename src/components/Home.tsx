        ...
        <main className='flex flex-col gap-28'>
            <section className='min-h-screen flex flex-col items-center justify-center bg-background dark:bg-dark-background gap-4 p-8'>
                ...
                <p className='text-lg text-secondary dark:text-dark-secondary max-w-4xl text-center px-4 mb-8'>
                        We are currently building 2 products: <strong> Solaris </strong> - a multi-platform decision-making agent that operates across various messaging applications globally, and <strong> Charis </strong> - a patient monitoring system that uses AI to help improve mental health outcomes for psychology and counselling clinics.
                </p>
